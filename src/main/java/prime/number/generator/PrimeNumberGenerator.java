...
public class PrimeNumberGenerator implements PrimeNumberGeneratorInterface {
	...
	public boolean isPrime(int value) {
		List<Integer> unitPlacePrimes = Arrays.asList(new Integer[] { 1, 3, 7, 9 }); // prime numbers after 5 can only
																						// have these values in unit
																						// place
		if (value < 2) {
			return false;
	...
	// given a value, find the index of the value in a sorted list that is closest
	// without going over.
